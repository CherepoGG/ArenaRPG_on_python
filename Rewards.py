...
class Rewards:
    ...
    def give_armor(self, player, part_armor, quality):  # TODO: FOR TESTING
        if quality == 1:
            quality = Item.common
        elif quality == 2:
            quality = Item.magic
    ...
    def give_weapon(self, player):  # TODO: FOR TESTING
